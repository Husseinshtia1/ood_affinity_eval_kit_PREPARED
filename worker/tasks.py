    ...
    with SessionLocal() as db:
        ...
        try:
            ...
            db.add(AuditLog(
                ...
                action='INVITATION_DELIVERY_SENT' if delivered else 'INVITATION_DELIVERY_SKIPPED',
                resource_type='invitation',
                resource_id=str(invitation.id),
                metadata_json={'email': invitation.email, 'attempts': invitation.delivery_attempts},
            ))
            db.commit()
            ...
            db.add(AuditLog(
                ...
                resource_type='invitation',
                resource_id=str(invitation.id),
                metadata_json={'email': invitation.email, 'attempts': invitation.delivery_attempts, 'error': error[:500]},
            ))
            db.commit()
